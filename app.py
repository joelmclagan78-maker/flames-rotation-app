...
st.set_page_config(page_title="Flames Master v3.6", layout="centered")
st.markdown("""
    <style>
...
if st.session_state.page == "Setup":
    ...
    # NEW: Finishing 5 selection moved to start
...
# --- GAME PAGE: NO-SCROLL GRID ---
    ...
    # RESTORED: Control Bar with Pause
    ...
    # NEW: Quick Switch to Finishing 5
    ...
    for name, data in st.session_state.players.items():
        ...
        # RESTORED: Bench Counter (🪑) and Gas Warning (⚠️)
        ...
        # RESTORED: Minute Adjustment Buttons
    ...
    # FIXED: Background Engine for Timer and Increases
